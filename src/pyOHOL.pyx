...
def groundtest():
	return "DRAWFLOOR 0 0 0#DRAWFLOOR 1 0 1#DRAWFLOOR 2 0 2#DRAWFLOOR 3 0 3#DRAWFLOOR 4 0 4#DRAWFLOOR 0 1 5#DRAWFLOOR 1 1 6#DRAWFLOOR 2 1 7"	
def fill(floor="0"):
	out = []
...
def tile():
	...
	for x in range(tilesperscreen):
		for y in range(tilesperscreen):
			out.append("DRAWFLOOR {} {} {}".format(x,y,(y*(tilesperscreen-1)+x)%7))
	return "#".join(out)
macros = {
	"GROUNDTEST": groundtest,
	"FILLGRASS": lambda: fill("0"),
	"FILLCLAY": lambda: fill("1"),
	"FILLDESERT": lambda: fill("2"),
	"FILLGRAVEL": lambda: fill("3"),
